...
export const FIELD_HELP: Record<string, string> = {
  ...
  "gateway.reload.deferralTimeoutMs":
    "Optional maximum time (ms) to wait for ordinary in-flight operations before forcing a restart. Omit to use the default bounded wait; set 0 to wait indefinitely with periodic still-pending warnings. Active Gateway setup wizards remain protected until they finish or their 30-minute session expires. Lower positive values risk aborting active subagent LLM calls.",
