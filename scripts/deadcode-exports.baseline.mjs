...
export const KNIP_UNUSED_EXPORT_BASELINE = [
  ...
  "extensions/qa-lab/src/live-transports/matrix/profiles.ts: MATRIX_QA_ALL_SCENARIO_IDS",
  "extensions/qa-lab/src/live-transports/matrix/scenarios/scenario-contract.ts: MATRIX_QA_E2EE_ROOM_KEY",
  "extensions/qa-lab/src/live-transports/matrix/scenarios/scenario-runtime-cli.ts: resolveMatrixQaOpenClawCliEntryPath",
  "extensions/qa-lab/src/live-transports/matrix/scenarios/scenario-runtime-cli.ts: testing",
  "extensions/qa-lab/src/live-transports/matrix/scenarios/scenario-runtime-shared.ts: MatrixQaSyncStreams",
  "extensions/qa-lab/src/live-transports/matrix/scenarios/scenario-types.ts: MatrixQaScenarioArtifacts",
  "extensions/qa-lab/src/live-transports/matrix/substrate/client.ts: testing",
  "extensions/qa-lab/src/live-transports/matrix/substrate/config.ts: buildMatrixQaConfigSnapshot",
  "extensions/qa-lab/src/live-transports/matrix/substrate/config.ts: MatrixQaConfigSnapshot",
  "extensions/qa-lab/src/live-transports/matrix/substrate/config.ts: summarizeMatrixQaConfigSnapshot",
  "extensions/qa-lab/src/live-transports/matrix/substrate/e2ee-client.ts: testing",
  "extensions/qa-lab/src/live-transports/matrix/substrate/fault-proxy.ts: MatrixQaFaultProxy",
  "extensions/qa-lab/src/live-transports/matrix/substrate/harness.runtime.ts: testing",
  "extensions/qa-lab/src/live-transports/matrix/substrate/harness.runtime.ts: writeMatrixQaHarnessFiles",
  "extensions/qa-lab/src/live-transports/matrix/substrate/recording-proxy.ts: normalizeMatrixQaRoute",
  "extensions/qa-lab/src/live-transports/matrix/substrate/topology.ts: buildDefaultMatrixQaTopologySpec",
  "extensions/qa-lab/src/live-transports/shared/live-artifacts.ts: createLiveTransportQaRunId",
